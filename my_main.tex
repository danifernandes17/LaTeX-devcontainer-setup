...
\usepackage{tikz}
% ponytail: acmart already loads amsfonts/amssymb via newtxmath
...
% ponytail: removed newblock env — clashes with natbib's \newblock, and was unused
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\linewidth]{images/daniela_trace_fig_hidden.jpg}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.8\linewidth]{images/comparison_3modes.pdf}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.7\linewidth]{images/violin_estimation_error.pdf}
